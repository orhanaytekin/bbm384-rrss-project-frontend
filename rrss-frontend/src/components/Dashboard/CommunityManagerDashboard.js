...
import { FaHistory,FaUser, FaMapMarkerAlt, FaHeart, FaKey, FaCreditCard, FaStar, FaHome, FaSignOutAlt, FaAddressBook, FaDochub, FaDatabase } from 'react-icons/fa';
...
const CommunityManagerDashboard = () => {
  ...
  return (
    <div className="user-dashboard">
      <h2>Community Manager Profile</h2>
      <div className="dashboard-grid">
        ...
        <Card icon={<FaCreditCard />} title="Credit Cards" navigateTo="/dashboard/credit-cards" />
              <Card icon={<FaDatabase />} title="All Reviews" navigateTo="/reviews" />
